...
static const union AnimCmd sSpriteAnim_DoubleExclMark[] =
{
    ANIMCMD_FRAME(2, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_X[] =
{
    ANIMCMD_FRAME(3, 60),
    ANIMCMD_END
};
...
static const union AnimCmd *const sSpriteAnimTable_Icons[] =
{
    ...
    [EMOTE_DOUBLE_EXCL_MARK] = sSpriteAnim_DoubleExclMark,
    [EMOTE_X]                = sSpriteAnim_X,
};
...
const u16 gEmoteIdToFldEffId[EMOTE_COUNT] =
{
    ...
    [EMOTE_DOUBLE_EXCL_MARK] = FLDEFF_DOUBLE_EXCL_MARK_ICON,
    [EMOTE_X]                = FLDEFF_X_ICON,
};
...
{
    return SetIconSpriteData(EMOTE_DOUBLE_EXCL_MARK);
}

u8 FldEff_XIcon(void)
{
    return SetIconSpriteData(EMOTE_X);
}
