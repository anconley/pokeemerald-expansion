...
static void SetIconSpriteDataOld(struct Sprite *sprite, u16 fldEffId, u8 spriteAnimNum);
...
static const struct SpriteFrameImage sSpriteImageTable_ExtraEmotions[] =
{
    {
...
static const union AnimCmd sSpriteAnim_ExtraEmotions1[] =
{
    ANIMCMD_FRAME(0, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_ExtraEmotions2[] =
{
    ANIMCMD_FRAME(1, 60),
    ANIMCMD_END
};

static const union AnimCmd *const sSpriteAnimTable_ExtraEmotions[] =
{
    sSpriteAnim_ExtraEmotions1,
    sSpriteAnim_ExtraEmotions2,
};

static const struct SpriteTemplate sSpriteTemplate_ExtraEmotions =
{
    .tileTag = TAG_NONE,
    .paletteTag = FLDEFF_PAL_TAG_ARROW,
    .oam = &sOamData_Icons,
    .anims = sSpriteAnimTable_ExtraEmotions,
    .images = sSpriteImageTable_ExtraEmotions,
    .affineAnims = gDummySpriteAffineAnimTable,
    .callback = SpriteCB_TrainerIcons
};
...
{
    u8 spriteId = CreateSpriteAtEnd(&sSpriteTemplate_ExtraEmotions, 0, 0, 0x53);

    if (spriteId != MAX_SPRITES)
        SetIconSpriteDataOld(&gSprites[spriteId], FLDEFF_EXCLAMATION_MARK_ICON, 2);
...
u8 FldEff_XIcon(void)
{
    ...
    if (spriteId != MAX_SPRITES)
        SetIconSpriteDataOld(&gSprites[spriteId], FLDEFF_EXCLAMATION_MARK_ICON, 3);
