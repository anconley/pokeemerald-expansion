...
const u8 gText_CantUseGauntlet[] = _("This can't be used during a\ngauntlet.{PAUSE_UNTIL_PRESS}");
const u8 gText_AtLevelCap[] = _("This POKéMON is already at the level cap.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepellentOn[] = _("{PLAYER} turned on the Repellent.\pWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_RepellentOff[] = _("{PLAYER} turned off the Repellent.\pWild POKéMON will no longer be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TrainerCardLevel[] = _("Level ");
