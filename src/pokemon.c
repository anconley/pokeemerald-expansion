...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    // Alolan Forms
    [SPECIES_RATTATA_ALOLAN - 1] = NATIONAL_DEX_RATTATA_ALOLA,
    [SPECIES_RATICATE_ALOLAN - 1] = NATIONAL_DEX_RATICATE_ALOLA,
    [SPECIES_RAICHU_ALOLAN - 1] = NATIONAL_DEX_RAICHU_ALOLA,
    [SPECIES_SANDSHREW_ALOLAN - 1] = NATIONAL_DEX_SANDSHREW_ALOLA,
    [SPECIES_SANDSLASH_ALOLAN - 1] = NATIONAL_DEX_SANDSLASH_ALOLA,
    [SPECIES_VULPIX_ALOLAN - 1] = NATIONAL_DEX_VULPIX_ALOLA,
    [SPECIES_NINETALES_ALOLAN - 1] = NATIONAL_DEX_NINETALES_ALOLA,
    [SPECIES_DIGLETT_ALOLAN - 1] = NATIONAL_DEX_DIGLETT,
    [SPECIES_DUGTRIO_ALOLAN - 1] = NATIONAL_DEX_DUGTRIO,
    [SPECIES_MEOWTH_ALOLAN - 1] = NATIONAL_DEX_MEOWTH_ALOLA,
    [SPECIES_PERSIAN_ALOLAN - 1] = NATIONAL_DEX_PERSIAN_ALOLA,
    [SPECIES_GEODUDE_ALOLAN - 1] = NATIONAL_DEX_GEODUDE_ALOLA,
    [SPECIES_GRAVELER_ALOLAN - 1] = NATIONAL_DEX_GRAVELER_ALOLA,
    [SPECIES_GOLEM_ALOLAN - 1] = NATIONAL_DEX_GOLEM_ALOLA,
    [SPECIES_GRIMER_ALOLAN - 1] = NATIONAL_DEX_GRIMER_ALOLA,
    [SPECIES_MUK_ALOLAN - 1] = NATIONAL_DEX_MUK_ALOLA,
    [SPECIES_EXEGGUTOR_ALOLAN - 1] = NATIONAL_DEX_EXEGGUTOR_ALOLA,
    [SPECIES_MAROWAK_ALOLAN - 1] = NATIONAL_DEX_MAROWAK_ALOLA,
    // Galarian Forms
    [SPECIES_MEOWTH_GALARIAN - 1] = NATIONAL_DEX_MEOWTH_GALAR,
    [SPECIES_PONYTA_GALARIAN - 1] = NATIONAL_DEX_PONYTA_GALAR,
    [SPECIES_RAPIDASH_GALARIAN - 1] = NATIONAL_DEX_RAPIDASH_GALAR,
    [SPECIES_SLOWPOKE_GALARIAN - 1] = NATIONAL_DEX_SLOWPOKE_GALAR,
    [SPECIES_SLOWBRO_GALARIAN - 1] = NATIONAL_DEX_SLOWBRO_GALAR,
    [SPECIES_FARFETCHD_GALARIAN - 1] = NATIONAL_DEX_FARFETCHD_GALAR,
    [SPECIES_WEEZING_GALARIAN - 1] = NATIONAL_DEX_WEEZING_GALAR,
    [SPECIES_MR_MIME_GALARIAN - 1] = NATIONAL_DEX_MR_MIME,
    [SPECIES_ARTICUNO_GALARIAN - 1] = NATIONAL_DEX_ARTICUNO_GALAR,
    [SPECIES_ZAPDOS_GALARIAN - 1] = NATIONAL_DEX_ZAPDOS_GALAR,
    [SPECIES_MOLTRES_GALARIAN - 1] = NATIONAL_DEX_MOLTRES_GALAR,
    [SPECIES_SLOWKING_GALARIAN - 1] = NATIONAL_DEX_SLOWKING_GALAR,
    [SPECIES_CORSOLA_GALARIAN - 1] = NATIONAL_DEX_CORSOLA_GALAR,
    [SPECIES_ZIGZAGOON_GALARIAN - 1] = NATIONAL_DEX_ZIGZAGOON_GALAR,
    [SPECIES_LINOONE_GALARIAN - 1] = NATIONAL_DEX_LINOONE_GALAR,
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_DARUMAKA_GALARIAN - 1] = NATIONAL_DEX_DARUMAKA_GALAR,
    [SPECIES_DARMANITAN_GALARIAN - 1] = NATIONAL_DEX_DARMANITAN_GALAR,
    [SPECIES_YAMASK_GALARIAN - 1] = NATIONAL_DEX_YAMASK_GALAR,
    [SPECIES_STUNFISK_GALARIAN - 1] = NATIONAL_DEX_STUNFISK,
#endif
//Hisuian Forms
    [SPECIES_GROWLITHE_HISUIAN - 1] = NATIONAL_DEX_GROWLITHE_HISUI,
    [SPECIES_ARCANINE_HISUIAN - 1] = NATIONAL_DEX_ARCANINE_HISUI,
    [SPECIES_VOLTORB_HISUIAN - 1] = NATIONAL_DEX_VOLTORB_HISUI,
    [SPECIES_ELECTRODE_HISUIAN - 1] = NATIONAL_DEX_ELECTRODE_HISUI,
    ...
    [SPECIES_LILLIGANT_HISUIAN - 1] = NATIONAL_DEX_LILLIGANT_HISUI,
    [SPECIES_ZORUA_HISUIAN - 1] = NATIONAL_DEX_ZORUA_HISUI,
    [SPECIES_ZOROARK_HISUIAN - 1] = NATIONAL_DEX_ZOROARK_HISUI,
    ...
    // Wormadam
    [SPECIES_WORMADAM_SANDY_CLOAK - 1] = NATIONAL_DEX_WORMADAM_SANDY,
    [SPECIES_WORMADAM_TRASH_CLOAK - 1] = NATIONAL_DEX_WORMADAM_TRASH,
    // Cherrim
    ...
    // Rotom
    [SPECIES_ROTOM_HEAT - 1] = NATIONAL_DEX_ROTOM_HEAT,
    [SPECIES_ROTOM_WASH - 1] = NATIONAL_DEX_ROTOM_WASH,
    [SPECIES_ROTOM_FROST - 1] = NATIONAL_DEX_ROTOM_FROST,
    [SPECIES_ROTOM_FAN - 1] = NATIONAL_DEX_ROTOM_FAN,
    [SPECIES_ROTOM_MOW - 1] = NATIONAL_DEX_ROTOM_MOW,
    // Origin Forme
    ...
    // Meowstic
    [SPECIES_MEOWSTIC_FEMALE - 1] = NATIONAL_DEX_MEOWSTIC_F,
    // Aegislash
    ...
    // Lycanroc
    [SPECIES_LYCANROC_MIDNIGHT - 1] = NATIONAL_DEX_LYCANROC_MIDNIGHT,
    ...
    // Toxtricity
    [SPECIES_TOXTRICITY_LOW_KEY - 1] = NATIONAL_DEX_TOXTRICITY_LOW_KEY,
    // Sinistea
