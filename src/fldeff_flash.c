...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_OUTDOOR_DUNGEON, MAP_TYPE_UNDERGROUND, TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_OUTDOOR_DUNGEON, FALSE,  TRUE, DoExitCaveTransition},
