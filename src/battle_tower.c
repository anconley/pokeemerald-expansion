...
#define RUBY_TO_EMERALD(version, facilityClass)  {version##_##facilityClass, facilityClass}

// Excludes the unused RS_FACILITY_CLASS_BOARDER_1, _2 and RS_FACILITY_CLASS_MAGMA_ADMIN_F
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 3][2] =
{
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AQUA_LEADER_ARCHIE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AQUA_GRUNT_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AQUA_GRUNT_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AROMA_LADY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_RUIN_MANIAC),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_INTERVIEWER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_TUBER_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_TUBER_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_COOLTRAINER_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_COOLTRAINER_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_HEX_MANIAC),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LADY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BEAUTY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_RICH_BOY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_POKEMANIAC),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SWIMMER_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BLACK_BELT),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_GUITARIST),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_KINDLER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_CAMPER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BUG_MANIAC),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PSYCHIC_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PSYCHIC_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_GENTLEMAN),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_ELITE_FOUR_SIDNEY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_ELITE_FOUR_PHOEBE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_ROXANNE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_BRAWLY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_TATE_AND_LIZA),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SCHOOL_KID_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SCHOOL_KID_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SR_AND_JR),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_POKEFAN_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_POKEFAN_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_EXPERT_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_EXPERT_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_YOUNGSTER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_CHAMPION_WALLACE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_FISHERMAN),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_CYCLING_TRIATHLETE_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_CYCLING_TRIATHLETE_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_RUNNING_TRIATHLETE_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_RUNNING_TRIATHLETE_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SWIMMING_TRIATHLETE_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SWIMMING_TRIATHLETE_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_DRAGON_TAMER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BIRD_KEEPER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_NINJA_BOY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BATTLE_GIRL),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PARASOL_LADY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SWIMMER_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PICNICKER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_TWINS),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SAILOR),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_COLLECTOR),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_WALLY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BRENDAN),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BRENDAN_2),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BRENDAN_3),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAY_2),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAY_3),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PKMN_BREEDER_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PKMN_BREEDER_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PKMN_RANGER_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_PKMN_RANGER_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAGMA_LEADER_MAXIE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAGMA_GRUNT_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAGMA_GRUNT_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LASS),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_BUG_CATCHER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_HIKER),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_YOUNG_COUPLE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_OLD_COUPLE),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_SIS_AND_BRO),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AQUA_ADMIN_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_AQUA_ADMIN_F),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_MAGMA_ADMIN_M),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_WATTSON),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_FLANNERY),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_NORMAN),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_WINONA),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_LEADER_JUAN),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_ELITE_FOUR_GLACIA),
    RUBY_TO_EMERALD(RS, FACILITY_CLASS_ELITE_FOUR_DRAKE),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_YOUNGSTER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BUG_CATCHER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_LASS),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SAILOR),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_CAMPER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PICNICKER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_POKEMANIAC),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SUPER_NERD),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_HIKER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BIKER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BURGLAR),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ENGINEER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_FISHERMAN),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SWIMMER_M),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_CUE_BALL),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_GAMER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BEAUTY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SWIMMER_F),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PSYCHIC_M),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ROCKER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_JUGGLER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_TAMER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BIRD_KEEPER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BLACK_BELT),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_RIVAL_EARLY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SCIENTIST),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_BOSS),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ROCKET_GRUNT_M),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_COOLTRAINER_M),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_COOLTRAINER_F),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ELITE_FOUR_LORELEI),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ELITE_FOUR_BRUNO),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_LEADER_BROCK),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_LEADER_MISTY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_GENTLEMAN),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_CHANNELER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_TWINS),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_COOL_COUPLE),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_YOUNG_COUPLE),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_CRUSH_KIN),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_SIS_AND_BRO),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PKMN_PROF),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RS_BRENDAN),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RS_MAY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_RED),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_LEAF),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_ROCKET_GRUNT_F),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PSYCHIC_F),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_CRUSH_GIRL),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_TUBER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PKMN_BREEDER),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PKMN_RANGER_M),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PKMN_RANGER_F),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_AROMA_LADY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_RUIN_MANIAC),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_LADY),
    RUBY_TO_EMERALD(FRLG, FACILITY_CLASS_RG_PAINTER),
};
...
} static const sFacilityClassEncounterMusic[] =
{
    {FACILITY_CLASS_LASS, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_YOUNGSTER, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_HIKER, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_BEAUTY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_FISHERMAN, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_CYCLING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    ...
    {FACILITY_CLASS_TUBER_F, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HEX_MANIAC, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PKMN_BREEDER_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RUNNING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RUNNING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_BATTLE_GIRL, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_CYCLING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_TUBER_M, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_GUITARIST, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_GENTLEMAN, TRAINER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_POKEFAN_M, TRAINER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_EXPERT_M, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_EXPERT_F, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_DRAGON_TAMER, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_BIRD_KEEPER, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_NINJA_BOY, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PARASOL_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_BUG_MANIAC, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_SAILOR, TRAINER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_COLLECTOR, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PKMN_RANGER_M, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_PKMN_RANGER_F, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_AROMA_LADY, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RUIN_MANIAC, TRAINER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_COOLTRAINER_M, TRAINER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_COOLTRAINER_F, TRAINER_ENCOUNTER_MUSIC_COOL},
    ...
    {FACILITY_CLASS_PICNICKER, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_PSYCHIC_M, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_PSYCHIC_F, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_SCHOOL_KID_F, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_PKMN_BREEDER_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_POKEFAN_F, TRAINER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_SWIMMER_F, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_SWIMMING_TRIATHLETE_M, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_SWIMMING_TRIATHLETE_F, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_SWIMMER_M, TRAINER_ENCOUNTER_MUSIC_SWIMMER}
};
...
u8 GetFrontierOpponentClass(u16 trainerId)
{
    ...
    {
        trainerClass = gPartners[trainerId - TRAINER_PARTNER(PARTNER_NONE)].trainerClass;
    }
    else if (trainerId < FRONTIER_TRAINERS_COUNT)
    {
...
void GetFrontierTrainerName(u8 *dst, u16 trainerId)
{
    ...
    {
        for (i = 0; i < PLAYER_NAME_LENGTH; i++)
            dst[i] = gPartners[trainerId - TRAINER_PARTNER(PARTNER_NONE)].trainerName[i];
    }
    else if (trainerId < FRONTIER_TRAINERS_COUNT)
    {
        for (i = 0; i < PLAYER_NAME_LENGTH; i++)
...
static void FillPartnerParty(u16 trainerId)
{
    ...
    {
        const struct Trainer *partner = &gPartners[trainerId - TRAINER_PARTNER(PARTNER_NONE)];
...
u8 GetFacilityClassEncounterMusicId(u8 facilityClass)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sFacilityClassEncounterMusic); i++)
    {
        if (sFacilityClassEncounterMusic[i].facilityClass == facilityClass)
            return sFacilityClassEncounterMusic[i].trainerEncounterMusic;
    }
