...
extern const u32 gTrainerFrontPic_RG_Red[];
extern const u32 gTrainerFrontPic_RG_Leaf[];
extern const u32 gTrainerFrontPic_RubySapphireBrendan[];
extern const u32 gTrainerFrontPic_RubySapphireMay[];
extern const u32 gTrainerFrontPic_RG_Youngster[];
extern const u32 gTrainerFrontPic_RG_BugCatcher[];
extern const u32 gTrainerFrontPic_RG_Lass[];
extern const u32 gTrainerFrontPic_RG_Sailor[];
extern const u32 gTrainerFrontPic_RG_Camper[];
extern const u32 gTrainerFrontPic_RG_Picnicker[];
extern const u32 gTrainerFrontPic_RG_PokeManiac[];
extern const u32 gTrainerFrontPic_RG_SuperNerd[];
extern const u32 gTrainerFrontPic_RG_Hiker[];
extern const u32 gTrainerFrontPic_RG_Biker[];
extern const u32 gTrainerFrontPic_RG_Burglar[];
extern const u32 gTrainerFrontPic_RG_Engineer[];
extern const u32 gTrainerFrontPic_RG_Fisherman[];
extern const u32 gTrainerFrontPic_RG_SwimmerM[];
extern const u32 gTrainerFrontPic_RG_CueBall[];
extern const u32 gTrainerFrontPic_RG_Gamer[];
extern const u32 gTrainerFrontPic_RG_Beauty[];
extern const u32 gTrainerFrontPic_RG_SwimmerF[];
extern const u32 gTrainerFrontPic_RG_PsychicM[];
extern const u32 gTrainerFrontPic_RG_Rocker[];
extern const u32 gTrainerFrontPic_RG_Juggler[];
extern const u32 gTrainerFrontPic_RG_Tamer[];
extern const u32 gTrainerFrontPic_RG_BirdKeeper[];
extern const u32 gTrainerFrontPic_RG_BlackBelt[];
extern const u32 gTrainerFrontPic_RG_RivalEarly[];
extern const u32 gTrainerFrontPic_RG_Scientist[];
extern const u32 gTrainerFrontPic_RG_LeaderGiovanni[];
extern const u32 gTrainerFrontPic_RG_RocketGruntM[];
extern const u32 gTrainerFrontPic_RG_CoolTrainerM[];
extern const u32 gTrainerFrontPic_RG_CoolTrainerF[];
extern const u32 gTrainerFrontPic_RG_EliteFourLorelei[];
extern const u32 gTrainerFrontPic_RG_EliteFourBruno[];
extern const u32 gTrainerFrontPic_RG_EliteFourAgatha[];
extern const u32 gTrainerFrontPic_RG_EliteFourLance[];
extern const u32 gTrainerFrontPic_RG_LeaderBrock[];
extern const u32 gTrainerFrontPic_RG_LeaderMisty[];
extern const u32 gTrainerFrontPic_RG_LeaderLtSurge[];
extern const u32 gTrainerFrontPic_RG_LeaderErika[];
extern const u32 gTrainerFrontPic_RG_LeaderKoga[];
extern const u32 gTrainerFrontPic_RG_LeaderBlaine[];
extern const u32 gTrainerFrontPic_RG_LeaderSabrina[];
extern const u32 gTrainerFrontPic_RG_Gentleman[];
extern const u32 gTrainerFrontPic_RG_RivalLate[];
extern const u32 gTrainerFrontPic_RG_ChampionRival[];
extern const u32 gTrainerFrontPic_RG_Channeler[];
extern const u32 gTrainerFrontPic_RG_Twins[];
extern const u32 gTrainerFrontPic_RG_CoolCouple[];
extern const u32 gTrainerFrontPic_RG_YoungCouple[];
extern const u32 gTrainerFrontPic_RG_CrushKin[];
extern const u32 gTrainerFrontPic_RG_SisAndBro[];
extern const u32 gTrainerFrontPic_RG_ProfessorOak[];
extern const u32 gTrainerFrontPic_RG_RocketGruntF[];
extern const u32 gTrainerFrontPic_RG_PsychicF[];
extern const u32 gTrainerFrontPic_RG_CrushGirl[];
extern const u32 gTrainerFrontPic_RG_TuberF[];
extern const u32 gTrainerFrontPic_RG_PokemonBreeder[];
extern const u32 gTrainerFrontPic_RG_PokemonRangerM[];
extern const u32 gTrainerFrontPic_RG_PokemonRangerF[];
extern const u32 gTrainerFrontPic_RG_AromaLady[];
extern const u32 gTrainerFrontPic_RG_RuinManiac[];
extern const u32 gTrainerFrontPic_RG_Lady[];
extern const u32 gTrainerFrontPic_RG_Painter[];
extern const u32 gTrainerFrontPic_RG_TuberM[];
...
extern const u16 gTrainerPalette_Tuber[];
...
extern const u16 gTrainerPalette_TeamMagma[];
...
extern const u16 gTrainerPalette_RG_RedLeaf[];
extern const u16 gTrainerPalette_RubySapphireBrendan[];
extern const u16 gTrainerPalette_RubySapphireMay[];
extern const u16 gTrainerPalette_RG_Youngster[];
extern const u16 gTrainerPalette_RG_BugCatcher[];
extern const u16 gTrainerPalette_RG_Lass[];
extern const u16 gTrainerPalette_RG_Sailor[];
extern const u16 gTrainerPalette_RG_Camper[];
extern const u16 gTrainerPalette_RG_Picnicker[];
extern const u16 gTrainerPalette_RG_PokeManiac[];
extern const u16 gTrainerPalette_RG_SuperNerd[];
extern const u16 gTrainerPalette_RG_Hiker[];
extern const u16 gTrainerPalette_RG_Biker[];
extern const u16 gTrainerPalette_RG_Burglar[];
extern const u16 gTrainerPalette_RG_Engineer[];
extern const u16 gTrainerPalette_RG_Fisherman[];
extern const u16 gTrainerPalette_RG_SwimmerM[];
extern const u16 gTrainerPalette_RG_CueBall[];
extern const u16 gTrainerPalette_RG_Gamer[];
extern const u16 gTrainerPalette_RG_Beauty[];
extern const u16 gTrainerPalette_RG_Rocker[];
extern const u16 gTrainerPalette_RG_Juggler[];
extern const u16 gTrainerPalette_RG_Tamer[];
extern const u16 gTrainerPalette_RG_BirdKeeper[];
extern const u16 gTrainerPalette_RG_Scientist[];
extern const u16 gTrainerPalette_RG_LeaderGiovanni[];
extern const u16 gTrainerPalette_RG_EliteFourLorelei[];
extern const u16 gTrainerPalette_RG_EliteFourBruno[];
extern const u16 gTrainerPalette_RG_EliteFourAgatha[];
extern const u16 gTrainerPalette_RG_EliteFourLance[];
extern const u16 gTrainerPalette_RG_LeaderBrock[];
extern const u16 gTrainerPalette_RG_LeaderMisty[];
extern const u16 gTrainerPalette_RG_LeaderLtSurge[];
extern const u16 gTrainerPalette_RG_LeaderErika[];
extern const u16 gTrainerPalette_RG_LeaderKoga[];
extern const u16 gTrainerPalette_RG_LeaderBlaine[];
extern const u16 gTrainerPalette_RG_LeaderSabrina[];
extern const u16 gTrainerPalette_RG_Gentleman[];
extern const u16 gTrainerPalette_RG_Rival[];
extern const u16 gTrainerPalette_RG_Channeler[];
extern const u16 gTrainerPalette_RG_Twins[];
extern const u16 gTrainerPalette_RG_CoolCouple[];
extern const u16 gTrainerPalette_RG_YoungCouple[];
extern const u16 gTrainerPalette_RG_CrushKin[];
extern const u16 gTrainerPalette_RG_SisAndBro[];
extern const u16 gTrainerPalette_RG_ProfessorOak[];
extern const u16 gTrainerPalette_RG_TeamRocket[];
extern const u16 gTrainerPalette_RG_Psychic[];
extern const u16 gTrainerPalette_RG_CrushGirl[];
extern const u16 gTrainerPalette_RG_Tuber[];
extern const u16 gTrainerPalette_RG_PokemonBreeder[];
extern const u16 gTrainerPalette_RG_PokemonRanger[];
extern const u16 gTrainerPalette_RG_AromaLady[];
extern const u16 gTrainerPalette_RG_RuinManiac[];
extern const u16 gTrainerPalette_RG_Lady[];
extern const u16 gTrainerPalette_RG_Painter[];

extern const u8 gTrainerBackPic_Brendan[];
extern const u8 gTrainerBackPic_May[];
extern const u8 gTrainerBackPic_RG_Red[];
extern const u8 gTrainerBackPic_RG_Leaf[];
extern const u8 gTrainerBackPic_RG_Pokedude[];
extern const u8 gTrainerBackPic_RG_OldMan[];
...
extern const u16 gTrainerBackPicPalette_RG_RedLeaf[];
extern const u16 gTrainerBackPicPalette_RG_Pokedude[];
extern const u16 gTrainerBackPicPalette_RG_OldMan[];
...
// Object event pics
extern const u8 gObjectEventPic_Fossil[];
...
extern const u16 gObjectEventPal_RG_RedLeaf[];
